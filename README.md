# Bus Booking & Dispatch Management Suite

Specialized bus dispatch and passenger booking suite managing routes, bus fleet capacities, ticket generation, and revenue reporting.
...
1. **Clone the repository**:
   ```bash
   git clone https://github.com/XREFS0/masa-bus-booking-sqlite.git
   cd masa-bus-booking-sqlite
   ```
